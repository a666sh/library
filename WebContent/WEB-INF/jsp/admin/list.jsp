...
<table  class="table table-bordered table-hover" align="center" width="1000">
	...
	<tr><td colspan="9"><a class="btn btn-warning" href="admin_listBeStop.do">已停用管理员列表</a></td></tr>
	...
	<tr>
		...
		<td>${type.name }</td>
		<td><s:if test="status==5"><a class="btn btn-default" href="admin_delete.action?id=${id }">启用管理员</a></s:if><s:else><a class="btn btn-danger" href="admin_delete.action?id=${id }">停用管理员</a></s:else>&nbsp;
