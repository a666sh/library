...
<body>
	<ul class="nav nav-tabs">
		...
		<li role="presentation" class="active"><a href="personType_addInput.do">添加读者类型</a></li>
	</ul>
	<br/><br/><br/>
			<div class="row">
			<div class="col-sm-6">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							<span><small>添加读者类型</small></span>
						</h3>
					</div>
					<div class="panel-body">
						<form class="form-horizontal center" action="personType_add.do"
							method="post">
							...
							<div class="form-group">
								<label for="maxNo" class="col-sm-4 control-label">
									可借阅最大数量(本):</label>
								<div class="col-sm-6">
									<input name="maxNo" type="number"
